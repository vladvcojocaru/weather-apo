...
def getWeather():
    city = textfield.get()
    # Use a proper user agent that identifies your application
...
# search box
Search_image = PhotoImage(file="./resources/search.png")
...
Search_icon = PhotoImage(file="resources/search_icon.png")
myimage_icon = Button(
...
# Bottom box
Frame_image = PhotoImage(file="resources/box.png")
